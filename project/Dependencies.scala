...
object Dependencies {
  ...
  object apache {
    val log4jToSlf4j = "org.apache.logging.log4j" % "log4j-to-slf4j" % "2.24.3"
  }
  ...
  object elasticsearch {
    val highLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.26"
  }
