...
object Dependencies {
  ...
  object apache {
    val log4jToSlf4j = "org.apache.logging.log4j" % "log4j-to-slf4j" % "2.21.1"
  }
  ...
  object testcontainers {
    val testcontainers              = "org.testcontainers" % "testcontainers" % "1.19.2"
    val testcontainersElasticsearch = "org.testcontainers" % "elasticsearch"  % "1.19.2"
  ...
  object elasticsearch {
    val highLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.15"
  }
