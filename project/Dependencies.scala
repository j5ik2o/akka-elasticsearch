...
object Dependencies {
  ...
  object slf4j {
    val api = "org.slf4j" % "slf4j-api" % "2.0.12"

  }

  object testcontainers {
    val testcontainers              = "org.testcontainers" % "testcontainers" % "1.19.7"
    val testcontainersElasticsearch = "org.testcontainers" % "elasticsearch"  % "1.19.7"
  ...
  object elasticsearch {
    val highLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.19"
  }
