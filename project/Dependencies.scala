...
object Dependencies {
  ...
  object apache {
    val log4jToSlf4j = "org.apache.logging.log4j" % "log4j-to-slf4j" % "2.24.0"
  }
  ...
  object testcontainers {
    ...
    val testcontainersElasticsearch = "org.testcontainers" % "elasticsearch"  % "1.20.1"
  ...
  object elasticsearch {
    val highLevelClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % "7.17.24"
  }
